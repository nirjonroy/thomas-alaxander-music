                            ...
                            <tbody style="color:black; font-size:12px" >
                                ...
                                @if(Auth::user()->hasRole('Employee'))
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                         <a href="{{ route('admin.order-recipct',$order->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-receipt"></i></a>
                                        <a href="{{ route('admin.order-show',$order->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a>
										<a href="{{ route('admin.order-edit',$order->id) }}" class="btn btn-success btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                        @if(auth()->user()->can('admin.delete-order'))
                                        	<a href="javascript:;" data-toggle="modal" data-target="#deleteModal" class="btn btn-danger btn-sm" onclick="deleteData({{ $order->id }})"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                      ...
                                      @endif
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            var now = new Date();
                                            var orderCreatedAt = new Date("{{ $order->created_at }}"); // Assuming $order->created_at contains the order creation date/time
                                            var timeDifference = (now.getTime() - orderCreatedAt.getTime()) / 1000; // Time difference in seconds

                                            // If the order was created less than 1 minute ago, show the modal
                            ...
                            @method('PUT')
                              ...
                              <div class="form-group">
                                  ...
                                  <select name="order_status" id="" class="form-control">
                                    ...
                                    <option {{ $order->order_status == 5 ? 'selected' : '' }} value="5">Paid</option>
                                  </select>
                              </div>
...
<div class="modal fade" id="newOrderModal" tabindex="-1" role="dialog" aria-labelledby="newOrderModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newOrderModalLabel">New Order Alert</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>New order created less than 1 minute ago!</p>
            </div>
            <div class="modal-footer">
