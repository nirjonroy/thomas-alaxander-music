      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Product Attribute/Combo</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="{{ route('admin.dashboard') }}">{{__('admin.Dashboard')}}</a></div>
              <div class="breadcrumb-item">Add Product Combo Here</div>
            </div>
          </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                <div class="modal-header">
                        <h5 class="modal-title"> Insert Combo </h5>
                ...
                <div class="container-fluid">
                    ...
                    <form action="{{ route('admin.store-size') }}" method="POST">
                        ...
                        <div class="form-group">
                              ...
                              <input type="text" name="title" placeholder="Combo Title">
