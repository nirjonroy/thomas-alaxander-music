                    ...
                    <div class="table-responsive ">
                      <table class="table table-striped table-hover table-md table-bordered" style="border-bottom: 1px solid #F9EDF7;">
                        <tr style="background: #F9EDF7;">
                          ...
                          @endif
                          <th width="10%" class="text-center">Combo</th>
                          <th width="10%" class="text-center">Flavour</th>
                          <th width="10%" class="text-center">Toping</th>
                          <th width="10%" class="text-center">Dip</th>
                          
                          <th width="10%" class="text-center">Cheese</th>
                          <th width="10%" class="text-center">vaggi</th>
                          <th width="10%" class="text-center">Sauce</th>
                          <th width="10%" class="text-center">Sides</th>
