    ...
    <section class="section">
        <div class="auth-section-wrapper">
            <div class="login-thumb">
                <img class="img" src="{{ asset($setting->logo) }}" alt="login-thumb" />
            </div>
            <div class="form-area-wrapper">
                <div class="form-content-wrapper">
                    ...
                    <div class="card card-primary card-wrapper-auth" style="border-top:#f8be2c !important">
                        <div class="card-body">
                            <div class="tex-content">
                                <h1>{{__('admin.Admin Dashboard')}}</h1>
                                <p class="des"> Login your Music Admin Panel </p>
                            </div>
                            <form class="needs-validation" novalidate="" action="{{ route('admin.user.stuff.login') }}"
                                method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="d-block">
                                        <label for="password"
                                            class="control-label">{{__('admin.Password')}}<sup>*</sup></label>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label"
                                            for="remember">{{__('admin.Remember Me')}}</label>
                                    </div>
                                </div>

                                <div class="form-group login-sub-btn">
                                    <button type="submit" class="btn btn-primary btn-lg btn-block" tabindex="4"
                                        style="background:#f8be2c !important; color:#000000">
                                        {{__('admin.Login')}}
                                    </button>
                                </div>
                            </form>
